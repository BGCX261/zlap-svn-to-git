...
public partial class _Default : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            Application["ratepromain"] = SetRateProduct(Application["idtypemobile"].ToString());
            ...
            SupportOnline();
            if (Application["appOnline2"] != null)
            {
                stronline = Application["appOnline2"].ToString();
            }
            ...
            if (Application["appOnline"] == null)
            {
                ...
                if (numOnline > 0)
                {
                    ...
                    for (int i = 0; i < numOnline; i++)
                    {
                        ...
                        strOnline2 += "<a href ='ymsgr:sendim?" + dsOnline.Tables[0].Rows[i]["nickname"].ToString() + "' title='" + dsOnline.Tables[0].Rows[i]["name"].ToString() + "'><img src='http://opi.yahoo.com/online?u=" + dsOnline.Tables[0].Rows[i]["nickname"].ToString() + "&m=g&t=1' border='0' class='space'/></a><br />";
                    }
                    strOnline += "</table>";
