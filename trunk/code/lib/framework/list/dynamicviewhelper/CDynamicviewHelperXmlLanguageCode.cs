...
{
    public class CDynamicviewHelperXmlLanguageCode : CDynamicViewHelper
    {
        ...
        public ArrayList GetNodeShow(bool Edit)
        {
            ...
            str = str + "<TH height='20' align='center' >Mô tả</TH>";
        ...
        public ArrayList GetNodeIteratorToShow(bool Edit)
        {
            ...
            if (navigator != null)
            {
                string xpath = string.Format("/language_code/code[position()>{0} and position()<={1}]", new string[] { GetFromRow().ToString(), GetToRow().ToString() });
        ...
        //public void SetIterator(XPathNodeIterator Iterator)
        //{
        //    this.nodess = Iterator;
        //}
        //protected XPathNodeIterator GetIterator()
        //{
        //    return this.nodess;
        //}
        public void SetStringSeach(string String_Search)
        {
            this.StringSearch = "/language_code/code[contains(key,'" + String_Search + "')]";
        }
    }
}
