...
function InnovaEditor(oName)
	...
	this.btnSave=false;this.btnPreview=false;this.btnFullScreen=false;this.btnPrint=false;this.btnSearch=false;
	this.btnSpellCheck=false;this.btnTextFormatting=false;
	this.btnListFormatting=false;this.btnBoxFormatting=false;this.btnParagraphFormatting=false;this.btnCssText=false;this.btnCssBuilder=false;
	this.btnStyles=false;this.btnParagraph=false;this.btnFontName=true;this.btnFontSize=true;
	...
	this.btnStrikethrough=true;this.btnSuperscript=false;this.btnSubscript=false;
	this.btnJustifyLeft=true;this.btnJustifyCenter=true;this.btnJustifyRight=true;this.btnJustifyFull=true;
	this.btnNumbering=true;this.btnBullets=true;this.btnIndent=true;this.btnOutdent=false;
	...
	this.btnTable=false;this.btnGuidelines=false;
	this.btnAbsolute=true;this.btnPasteWord=false;this.btnLine=true;
