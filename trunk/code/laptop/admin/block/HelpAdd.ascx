<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HelpAdd.ascx.cs" Inherits="admin_block_HelpAdd" %>
...
<tr>
  <td colspan="2" height="2"></td>
    ...
    <tr>
      ...
      <td style="height: 24px"><input type="button" id="btadd" runat="server" class="button" value="Thêm mới" onserverclick="btadd_ServerClick" /><input type="button" class="button" value="Quay lại" onclick="Back('help');" /></td>
    </tr>
  </table>