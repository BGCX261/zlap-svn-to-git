<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UploadmultiImgProduct.ascx.cs" Inherits="admin_block_UploadmultiImgProduct" %>
...
</td><td width="400"><input type="button" id="btsearchPro" value="Tìm kiếm" class="button"  onclick="searchProduct(3)"; /> <input type="button" id="Button1" class="button" value="Xem toàn bộ" onclick="viewAllPro(3);" /></td></tr>
