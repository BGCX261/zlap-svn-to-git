<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UploadImageMobile.ascx.cs" Inherits="admin_block_UploadImageMobile" %>
...
</td><td width="400"><input type="button" id="btsearchPro" value="Tìm kiếm" class="button"  onclick="searchProduct(2)"; /> <input type="button" id="Button1" class="button" value="Xem toàn bộ" onclick="viewAllPro(2);" /></td></tr>
