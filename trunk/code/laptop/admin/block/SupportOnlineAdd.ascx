<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SupportOnlineAdd.ascx.cs" Inherits="admin_block_SupportOnlineAdd" %>
...
<tr><td>Hỗ trợ cho</td><td>
<asp:DropDownList id="SlType" runat="server">
      <asp:ListItem value="1">Online Laptop</asp:ListItem>
      <asp:ListItem value="2">Online Điện thoại</asp:ListItem>
      </asp:DropDownList>
</td></tr>
<tr>
      <td colspan="2" height="5"></td>
...
<tr class="bgtr">
  ...
  <td style="height: 24px"><input type="button" id="btadd" runat="server" class="button" value="Thêm mới" onserverclick="btadd_ServerClick" /><input type="button" class="button" value="Quay lại" onclick="Back('onlinesupport');" /></td>
</tr>
</table>