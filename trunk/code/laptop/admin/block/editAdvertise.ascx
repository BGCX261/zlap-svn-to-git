<%@ Control Language="C#" AutoEventWireup="true" CodeFile="editAdvertise.ascx.cs" Inherits="admin_block_editAdvertise" %>
...
<tr>
  ...
  <td colspan="2" height="2"></td>
    ...
    <tr class="bgtr">
      ...
      <td style="height: 24px"><input type="button" id="btadd" runat="server" class="button" value="Chỉnh sửa" onserverclick="btadd_ServerClick" /><input type="button" class="button" value="Quay lại" onclick="Back('linkweb');" /></td>
    </tr>
  </table>