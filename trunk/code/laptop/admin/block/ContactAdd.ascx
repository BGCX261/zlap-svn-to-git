<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ContactAdd.ascx.cs" Inherits="admin_block_ContactAdd" %>
...
<tr><td width="120" class="title3">Hỗ trợ cho</td><td>
<asp:DropDownList id="SlType" runat="server">
      <asp:ListItem value="1">Địa chỉ bán Laptop</asp:ListItem>
      <asp:ListItem value="2">Địa chỉ bán Điện thoại</asp:ListItem>
      </asp:DropDownList>
</td></tr>
<tr>
  <td colspan="2" height="2"></td>
    ...
    <tr>
      ...
      <td style="height: 24px"><input type="button" id="btadd" runat="server" class="button" value="Thêm mới" onserverclick="btadd_ServerClick" /><input type="button" class="button" value="Quay lại" onclick="Back('contact');" /></td>
    </tr>
  </table>