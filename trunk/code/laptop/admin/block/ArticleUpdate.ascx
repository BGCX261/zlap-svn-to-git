<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ArticleUpdate.ascx.cs" Inherits="admin_block_ArticleUpdate" %>
...
<tr>
  <td colspan="2" height="2"></td>
    ...
    <tr class="bgtr">
      ...
      <td style="height: 24px"><input type="button" id="btedit" runat="server" class="button" value="Chỉnh sửa" onserverclick="btedit_ServerClick" /><input type="button" class="button" value="Quay lại" onclick="Back('article');" /></td>
    </tr>
  </table>