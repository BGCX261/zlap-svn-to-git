...
public partial class block_AdvanceSearch : System.Web.UI.UserControl
{
    ...
    public void BuildPageSearch()
    {
        ...
        str_search += "<tr align='center'><td>" + values[7] + "</td><td>" + values[3] + "</td></tr>";
        str_search += " <tr><td height='10'></td><td></td></tr>";
        str_search += "<tr align='center'><td>" + values[1] + "</td><td>" + values[4] + "</td></tr>";
        str_search += " <tr><td height='10'></td><td></td></tr>";
        str_search += "<tr align='center'><td>" + values[0] + "</td><td>" + values[5] + "</td></tr>";
        str_search += " <tr><td height='10'></td><td></td></tr>";
        str_search += "<tr align='center'><td>" + values[2] + "</td><td>" + values[6] + "</td></tr>";
        str_search += " <tr><td height='10'></td><td></td></tr>";
