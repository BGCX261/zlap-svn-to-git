    ...
    public void GetDetailProduct(DataTable table, DataTable add)
    {
        try
        {
            if (table.Rows.Count > 0)
            {
                ...
                tcurrentAccess += "<a href='?menu=igc&id=" + idgroup + "'>" + strgroup + "</a> &raquo; " + strname;
                ...
                strpro += "<tr><td>" + tprice + ":</td><td class='price'>" + strprice + " " + unitPrice + "</td></tr>";
                strpro += "<tr><td colspan='2' class='bg_line2'></td></tr>";
        ...
        if (numPro > 0)
        {
            ...
            for (int i = 0; i < numPro; i++)
            {
                ...
                if (iseven)
                {
                    ...
                    strProMain += "<tr><td rowspan='2' width='115'><a href='?menu=dc&id=" + id + "'><img class='border_img' src='" + url + "'/></a></td>";
                    strProMain += "<td valign='top' class='text_title'><a href='?menu=dc&id=" + id + "' onmouseover=\"ShowSpeccom('" + note + "',event);\" onmouseout='OnMOut(event)'>" + name + "</a></td></tr>";
                    strProMain += "<tr><td>" + tbrand + ": <span class='price'>" + brand + "</span><br />" +tprice + ": <span class='price'>" + price + " " + unitPrice + "</span><br />" + twarranty + ": <span class='price'>" + warranty + " " + tmonth + "</span></td></tr>";
