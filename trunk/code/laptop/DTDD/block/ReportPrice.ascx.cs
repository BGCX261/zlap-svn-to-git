...
public partial class block_ReportPrice : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string _nameFile = "bao_gia_mobile.xls";
        ...
        if(isCreatenewExcel)
        {
            ...
            {
                string table = "";
                table = ProducttoExcel("USD", 0, (int)Application["idtypemobile"]);
                if (table.Length == 0)
                {
    ...
    public string ProducttoExcel(string Currency, int idbrand, int idtype)
    {
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    table += "<td colspan='3' style='border-width:0px;'><b>Báo giá điện thoại di động:</b>: Ngày <i>" + timecurrent.ToString("dd/MM/yy") + ", " + timecurrent.ToShortTimeString() + "(Giờ Hà Nội)</i></td><td align='center' style='border-width:0px;'>" + Exchange + "</td><td colspan='3' style='border-width:0px;'></td></tr>";
                }
                //table += "<td colspan='3' style='border-width:0px;'><b>Báo giá máy tính xách tay</b>: Ngày <i>" + timecurrent.ToString("dd/MM/yy") + ", " + timecurrent.ToShortTimeString() + "(Giờ Hà Nội)</i></td><td align='center' style='border-width:0px;'></td><td colspan='3' style='border-width:0px;'></td></tr>";
